...
let MovieListComponent = class MovieListComponent {
    constructor(movieService, navbarService) {
...
let MoviePreviewComponent = class MoviePreviewComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let MoviePreviewContainerComponent = class MoviePreviewContainerComponent {
    constructor(movieService, navbarService, route) {
        this.movieService = movieService;
        this.navbarService = navbarService;
        this.route = route;
    }
...
MoviePreviewContainerComponent.ctorParameters = () => [
    { type: _services_movie_service__WEBPACK_IMPORTED_MODULE_2__["MovieService"] },
...
let MovieService = class MovieService {
    ...
    movie(id) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(_models_movie_model__WEBPACK_IMPORTED_MODULE_3__["movies"].find(movie => +movie.id === +id));
    }
};
